...
from .const import (
    ...
    ATTR_TAGS,
    ATTR_TEMP_MAX,
    ATTR_TEMP_MAX_SOURCE,
    ATTR_TEMP_MIN,
    ATTR_TEMP_MIN_SOURCE,
    ATTR_TEMPERATURE_SOURCE_UNIT,
    ATTR_TEMPERATURE_UNIT,
    ATTR_WATERING_INTERVAL_DAYS,
    ATTR_WATERING_LOG_DAYS_AGO,
    CONF_LIGHT_ENTITY,
...
class PlantGuardianStatusSensor(PlantGuardianEntity, SensorEntity):
    ...
    def extra_state_attributes(self) -> dict:
        return {
            ...
            ATTR_TEMP_MIN_SOURCE: self.coordinator.data.temp_min_source,
            ATTR_TEMP_MAX_SOURCE: self.coordinator.data.temp_max_source,
            ATTR_TEMPERATURE_UNIT: self.coordinator.data.temperature_unit,
            ATTR_TEMPERATURE_SOURCE_UNIT: self.coordinator.data.temperature_source_unit,
            ...
            ATTR_WATERING_LOG_DAYS_AGO: self.coordinator.data.watering_log_days_ago,
            ATTR_FERTILIZING_LOG_DAYS_AGO: self.coordinator.data.fertilizing_log_days_ago,
